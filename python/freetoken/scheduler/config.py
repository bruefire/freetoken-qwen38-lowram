...
class SchedulerConfig(EngineConfig):
    ...
    # 0 disables live decode profiling. A positive value emits one torch.profiler
    # aggregate after each window of this many completed decode forwards.
    decode_profile_interval: int = 0
