...
class SchedulerStatusReporter:
    ...
    decode_stats_log: Callable[[], str | None] | None = None
    ...
    def _report_decode(
        ...
        *,
        ...
        self._decode_generated_tokens += (
            getattr(batch, "generated_tokens", 0) or len(batch.reqs)
        )
        ...
        if self.decode_stats_log is not None:
            stats_line = self.decode_stats_log()
