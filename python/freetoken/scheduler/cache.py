...
class CacheManager:
    ...
    def release_allocated_tail(
        ...
        A partial page containing committed tokens stays owned by the request. MTP
        currently uses page_size=1, but the page-rounded implementation keeps the
        helper safe for other generic paged caches.
        """
