...
def _probe(fn) -> None:
    ...
    # The copy runs on a fresh stream.  Do not initialize ``dst`` on the
    # current/default stream without recording a dependency: that would race
    # the initialization against cudaMemcpyBatchAsync.
