...
class CpuMoeExecutor:
    ...
    def decode_submit(
        ...
        with decode_profile_range("FT.MoE.CPUSubmitAndD2H"):
            return self._decode_submit_impl(layer_id, hidden_states, topk_weights, topk_ids)

    def _decode_submit_impl(
        self,
        layer_id: int,
        hidden_states: torch.Tensor,
        topk_weights: torch.Tensor,
    ...
    def decode_sync(self, pending: tuple) -> torch.Tensor:
        ...
        with decode_profile_range("FT.MoE.CPUWaitAndH2D"):
